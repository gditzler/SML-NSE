function [err, kap] = learn_nse(net, data_train, labels_train, data_test, ...
...
for ell = 1:n_timestamps
  ...
  err(ell) = calc_error(predictions, labels_test_t);
  kap(t) = kappa(confusionmat(labels_test_t, predictions));
